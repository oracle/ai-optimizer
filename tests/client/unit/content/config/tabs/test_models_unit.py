...
class TestModelInitialization:
    ...
    def test_initialize_model_add(self, monkeypatch):
...
class TestClearClientModels:
    ...
    def test_clear_client_models_ll_model(self, monkeypatch):
    ...
    def test_clear_client_models_no_match(self, monkeypatch):
