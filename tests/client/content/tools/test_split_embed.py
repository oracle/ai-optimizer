...
class TestStreamlit:
    ...
    def test_file_selection_local(self, app_server, app_test, monkeypatch):
    ...
    def test_file_selection_oci(self, app_server, app_test, monkeypatch):
    ...
    def test_vector_store_creation(self, app_server, app_test, monkeypatch):
