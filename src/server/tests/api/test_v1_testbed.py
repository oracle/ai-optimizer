...
async def test_list_testsets_no_auth(app_client):
    """GET testsets rejects requests without credentials."""
...
async def test_list_evaluations_no_auth(app_client):
    """GET evaluations rejects requests without credentials."""
...
async def test_get_evaluation_no_auth(app_client):
    """GET evaluation rejects requests without credentials."""
...
async def test_get_testset_qa_no_auth(app_client):
    """GET testset_qa rejects requests without credentials."""
...
async def test_delete_testset_no_auth(app_client):
    """DELETE testset rejects requests without credentials."""
...
async def test_upload_testset_no_auth(app_client):
    """POST testset_load rejects requests without credentials."""
...
async def test_generate_testset_no_auth(app_client):
    """POST testset_generate rejects requests without credentials."""
...
async def test_evaluate_no_auth(app_client):
    """POST evaluate rejects requests without credentials."""
