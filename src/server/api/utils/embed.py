...
def process_metadata(idx: int, chunk: str) -> str:
    ...
    filename = os.path.basename(chunk.meta.origin.filename)
    print(filename)
    ...
    split_doc_with_mdata.append(LangchainDocument(page_content=str(chunk.text), metadata=chunk_metadata))
...
def load_and_split_documents(
    ...
    for file in src_files:
        ...
        split = True
        try:
            loaded_doc = converter.convert(file)
        ...
        loaded_doc = loaded_doc.document
