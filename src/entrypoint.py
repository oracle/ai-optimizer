...
def _prepare_auth_streamlit_config(script_dir: Path, cookie_secret: str) -> None:
    ...
    issuer = os.environ.get("AIO_AUTH_ISSUER", "http://127.0.0.1:8765").rstrip("/")
    configured_redirect_uri = os.environ.get("AIO_AUTH_WEB_REDIRECT_URI")
    ...
    if secrets_file_exists:
        ...
        generated_config = (
            ...
            and auth_config.get("client_kwargs") == {"scope": "openid profile email"}
            and auth_config.get("expose_tokens") == "access"
            and (_GENERATED_OIDC_CONFIG_MARKER in contents)
        )
        placeholder_config = (
