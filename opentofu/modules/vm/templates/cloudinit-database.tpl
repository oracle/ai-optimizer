    ...
    content: |
      ...
      BEGIN
        FOR g IN (SELECT column_value AS stmt FROM TABLE(sys.odcivarchar2list(
          ...
          'GRANT SELECT ON SYS.DBA_DATA_ROLES TO "$DB_USERNAME"',
          'GRANT SELECT ON SYS.DBA_DATA_ROLE_GRANTS TO "$DB_USERNAME"',
          'GRANT SELECT ON SYS.DBA_END_USERS TO "$DB_USERNAME"',
