...
For defects or enhancement requests, please file a GitHub issue unless the
matter is security related. Clear, complete reports are more likely to be
resolved quickly. For security-sensitive reports, do not raise a GitHub issue;
...
Install the application dependencies and development tools from the repository root:
