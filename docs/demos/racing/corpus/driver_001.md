...
Driver 1 is running with a High Downforce baseline on Rig 01. The profile remains Defensive Racer, which fits the current programme as long as the driver links style to measurable outputs: lap-time spread, tyre deg, pit timing, and mistakes under pressure.
