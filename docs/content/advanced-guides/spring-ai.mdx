...
The AI Optimizer can generate a Spring AI application that uses the language model, embedding model, prompt, and Oracle AI Database vector store selected in the client. The generated application exposes an OpenAI-compatible RAG API that you can use as a starting point for a Java service.
