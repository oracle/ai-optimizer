...
**MCPTool** — References a single tool by name with explicit inputs and outputs, wired into a flow graph. The built-in Vector Search Flow uses this pattern. Adding a tool requires modifying the flow definition.
