...
The **AI Optimizer** can be used to interact with language models without having the database configured, however, grounded routes such as RAG and NL2SQL require a configured database.
:::
