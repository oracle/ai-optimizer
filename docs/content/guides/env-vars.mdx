...
| `AIO_CLIENT_PASSWORD`      | Shared password gating configuration and shared-state controls in the web client. This does not replace [**AI Optimizer Server**](../server/intro.mdx) authentication. See [Access Control](./access-control). | _(none)_    |
