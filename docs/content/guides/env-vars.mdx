...
These settings populate the DEFAULT OCI profile. See [OCI Configuration](../client/configuration/oci) for authentication requirements and supported authentication types.
