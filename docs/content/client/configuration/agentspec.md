...
The {{< full_app_ref >}} exposes portable [AgentSpec]({{< ref "/agents" >}}) definitions that describe agent pipelines as serializable JSON. These definitions can be inspected in the GUI, customized, and loaded into any compatible runtime.
