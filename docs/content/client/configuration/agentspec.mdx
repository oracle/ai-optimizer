...
The **Oracle AI Optimizer and Toolkit** (the **AI Optimizer**) exposes portable [AgentSpec](https://oracle.github.io/agent-spec) definitions that describe agents and flows as serializable JSON. These definitions can be inspected in the client, customized, and loaded into any compatible runtime.
