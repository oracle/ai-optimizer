...
Configuration can be done through the GUI, [environment files]({{% relref "/configuration" %}}), or a combination of both. After you configure the {{% short_app_ref %}}, you can export the settings and import them into another deployment or restore them after a restart.
