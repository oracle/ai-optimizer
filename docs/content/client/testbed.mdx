...
:::note[Access]
Test sets and evaluation reports are scoped to the authenticated principal. When API-key authentication is used, the configured API key represents the shared principal.
:::
