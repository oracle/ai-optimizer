...
The configured database user needs the Deep Data Security privileges described in the [Database Configuration](../../guides/database#deep-data-security-privileges) documentation. The tool reads the user's privileges and enables only the actions that are permitted; anything the user is not privileged to do is disabled.
...
1. Create a local [**data role**](#data-roles).
   ...
   ![DDS - Create Data Role](../../_assets/images/dds_create_data_role.png)

1. Create an [**end user**](#end-users) and assign the data role to it.
   
   ![DDS - Create Data User](../../_assets/images/dds_create_data_user.png)

1. If more than one end user exists, select the end user in **Connect tools as**.
   
   ![DDS - Select Data User](../../_assets/images/dds_select_data_user.png)
...
1. Create a [**data grant**](#data-grants) for that role, specifying the tables or views, privileges, and any column or row restrictions.
   ...
   ![DDS - Create Data Grant](../../_assets/images/dds_create_data_grant.png)
...
1. Use Vector Search or NL2SQL and enable **Deep Data Security** to confirm that the tools return only the data allowed by the grant.
   ...
   ![DDS - Enable on Chatbot](../../_assets/images/dds_enable.png)
