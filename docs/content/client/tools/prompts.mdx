...
Prompts provide instructions and templates that guide the language model and the tools used by the **Oracle AI Optimizer and Toolkit** (the **AI Optimizer**).
The runtime selects the appropriate chat prompt automatically from the tools enabled in the [Chatbot](../chatbot) configuration.
...
![Prompt selection list](../../_assets/images/prompts-description.png)
...
![Prompt selection list](../../_assets/images/prompts-selection.png)
