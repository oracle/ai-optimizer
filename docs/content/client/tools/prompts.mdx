...
Prompts provide instructions and templates for the model calls, agents, flows, and tools used by the **AI Optimizer**.
The [runtime](../../advanced-guides/agents/intro) selects the appropriate system prompt from the tools enabled in the [Chatbot](../chatbot) configuration.
