...
At query time, relevant chunks are retrieved using [Vector Search](../chatbot#vector-search) and injected into the Language Model context to produce grounded answers based on the provided information.
