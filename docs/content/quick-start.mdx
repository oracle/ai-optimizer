...
The **AI Optimizer** can be deployed into a Kubernetes cluster using a Helm chart. For more information, see the [Kubernetes](./advanced-guides/kubernetes) documentation.
