...
The [Racing Championship use-case](./use-cases/racing) walks the same **AI Optimizer** through an end-to-end demo that shows the progressive value of **NL2SQL**, **Vector Search**, and combined-mode grounding against a synthetic racing championship dataset. See all [Use Cases](./use-cases) for more.
:::
