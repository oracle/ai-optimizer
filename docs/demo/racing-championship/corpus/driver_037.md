...
Driver 37 is running with a Low Drag baseline on Rig 12. The profile remains Consistency Focused, which fits the current programme as long as the driver links style to measurable outputs: lap-time spread, tyre deg, pit timing, and mistakes under pressure.
