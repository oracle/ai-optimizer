...
Driver 13 is running with a Tyre Saver baseline on Rig 13. The profile remains Strategy Led, which fits the current programme as long as the driver links style to measurable outputs: lap-time spread, tyre deg, pit timing, and mistakes under pressure.
