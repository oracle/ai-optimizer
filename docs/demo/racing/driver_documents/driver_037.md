# Driver 37 Briefing Pack

Document type: Driver briefing and coaching notes
Driver label: Driver 37
Driver code: Driver037
Team: Velocity Forge
...
Driver 37 is running with a Low Drag baseline on Rig 12. The profile remains Consistency Focused, which fits the current Velocity Forge programme as long as the driver links style to measurable outputs: lap-time spread, tyre deg, pit timing, and mistakes under pressure.
