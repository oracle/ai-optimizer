# Driver 25 Briefing Pack

Document type: Driver briefing and coaching notes
Driver label: Driver 25
Driver code: Driver025
Team: Nova Circuit
...
Driver 25 is running with a Traction Focus baseline on Rig 25. The profile remains Tyre Saver, which fits the current Nova Circuit programme as long as the driver links style to measurable outputs: lap-time spread, tyre deg, pit timing, and mistakes under pressure.
